...
def cancelar_consulta_paciente(request, id_consulta):
    ...
    if request.user != consulta.paciente:
        messages.add_message(request, constants.ERROR, 'Essa consulta pertence a outro paciente.')
        return redirect('/pacientes/minhas_consultas/')
...
#TODO: Validação de segurança no restante dos pontos, para medico e paciente
#TODO: Botão Cancelar Consulta para médico e paciente
